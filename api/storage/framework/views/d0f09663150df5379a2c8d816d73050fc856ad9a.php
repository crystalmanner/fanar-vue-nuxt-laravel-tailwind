<router-link tag="h3" :to="{
    ...
    <span class="sidebar-label"><?php echo e(config('novapage.labels.pages')); ?></span>
</router-link>
<router-link tag="h3" :to="{
    name: 'index',
    params: {
    ...
    <span class="sidebar-label"><?php echo e(config('novapage.labels.options')); ?></span>
</router-link>
<?php /**PATH C:\xampp\htdocs\admin\vendor\whitecube\nova-page\src/../resources/views/navigation.blade.php ENDPATH**/ ?>